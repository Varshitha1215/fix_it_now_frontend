...
const CateringScheduleServices = () => {
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <textarea
            ...
            placeholder="Menu preferences (optional)"
            rows={3}
            style={{
              padding: '10px',
              marginTop: 4,
...
export default CateringScheduleServices;