...
const MaidScheduleServices = () => {
  ...
  const [serviceFrequency, setServiceFrequency] = useState('Daily');
  const [estimate, setEstimate] = useState(3000);
  const [success, setSuccess] = useState(false);
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState('');

  useEffect(() => {
    const costs = { Daily: 3000, 'Twice a Week': 1500, Weekly: 800 };
    setEstimate(costs[serviceFrequency] || 3000);
  }, [serviceFrequency]);
    ...
    >
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          >
            <option value="Daily">Daily - ₹3000/month</option>
            <option value="Twice a Week">Twice a Week - ₹1500/month</option>
            <option value="Weekly">Weekly - ₹800/month</option>
          </select>
        </div>
        <div
          style={{
...
export default MaidScheduleServices;