...
const LaundryScheduleServices = () => {
  ...
  const [serviceFrequency, setServiceFrequency] = useState('Daily Pickup');
  const [estimate, setEstimate] = useState(1500);
  ...
  useEffect(() => {
    ...
    setEstimate(costs[serviceFrequency] || 1500);
  }, [serviceFrequency]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setContact('+91');
        setExtraInfo('');
        setServiceFrequency('Daily Pickup');
        setSuccess(false);
      }, 2000);
    } catch (err) {
    ...
    >
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          >
            <option value="Daily Pickup">Daily Pickup - ₹1500/month</option>
            <option value="Twice a Week">Twice a Week - ₹800/month</option>
            <option value="Weekly">Weekly - ₹500/month</option>
          </select>
        </div>
        <div
          style={{
...
export default LaundryScheduleServices;