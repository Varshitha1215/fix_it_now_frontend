...
const GardeningScheduleServices = () => {
  ...
  useEffect(() => {
    ...
    setEstimate(costs[serviceFrequency] || 2000);
  }, [serviceFrequency]);
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <textarea
            ...
            placeholder="Garden details or special requirements (optional)"
            rows={3}
            style={{
              padding: '10px',
              marginTop: 4,
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          >
            <option value="Weekly">Weekly - ₹2000/month</option>
            <option value="Bi-weekly">Bi-weekly - ₹1200/month</option>
            <option value="Monthly">Monthly - ₹800/month</option>
          </select>
        </div>
        <div
          style={{
...
export default GardeningScheduleServices;