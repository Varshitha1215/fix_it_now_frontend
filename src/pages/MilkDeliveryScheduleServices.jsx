...
const MilkDeliveryScheduleServices = () => {
  ...
  const [numLiters, setNumLiters] = useState(1);
  ...
  return (
    ...
    >
      ...
      >
        Milk Delivery Schedule Services
      </h2>
      <form onSubmit={handleSubmit} autoComplete="off">
        <div style={{ marginBottom: 16 }}>
          ...
          >
            <option>Milk Delivery Services</option>
          </select>
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input
            ...
            max={100}
            value={numLiters}
            onChange={e => setNumLiters(Number(e.target.value))}
            style={{
              padding: '10px',
              marginTop: 4,
              borderRadius: 8,
...
export default MilkDeliveryScheduleServices;